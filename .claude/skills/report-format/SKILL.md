...
- Dòng của chủ đề có hậu tố `-doi` (ví dụ `reported_programs__ai-doi.md`, do routine đội agent ghi) được đồng bộ vào tab **"Đội agent"**. Tab này tự được tạo nếu chưa có. Các chủ đề khác ghi vào tab đầu tiên như cũ.
